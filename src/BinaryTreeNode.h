...
namespace Seven
{
	...
	*/
	...
	/*
	1. print value field
	2. print this node's address
	3. print this node's parent's address
	4. print this node's left child's address
	5. print this node's right child's address
	*/
	template<class T>
	...
	// default constructor
	/*
	create a binary tree node without set its value field and its parent and children are null
	*/
	template<class T>
	...
	/*
	create a binary tree node with setting its value field and its parent and children are null
	*/
	template<class T>
	...
	// get the address of its value field
	template<class T>
